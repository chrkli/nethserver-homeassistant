Summary: nethserver-homeassistant is a module to install homeassistant as docker container
%define name nethserver-homeassistant
Name: %{name}
...
%description
A module to install homeassistant as docker container
...
%{__mkdir_p} -p $RPM_BUILD_ROOT/var/lib/homeassistant/config
...
%changelog
* Mon, Feb 22 2021 chrkli 1.0.1
- refactor to homeassistant
